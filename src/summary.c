...
bool
tloc_summary_file_summaries_init(TLOC_File_Summaries *summaries, size_t initial_capacity)
{
...
bool
tloc_summary_file_summaries_append(TLOC_File_Summaries *summaries, TLOC_File_Summary *file_summary)
{
...
void
tloc_summary_file_summaries_destroy(TLOC_File_Summaries *summaries)
{
    if (summaries->items)
    {
...
tloc_summary_find_or_create_language_summary(TLOC_Language_Summary **groups, int *groups_count,
