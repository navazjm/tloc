...
bool
tloc_options_init(TLOC_Options *opts)
{
...
void
tloc_options_destroy(TLOC_Options *opts)
{
    if (opts->path)
    {
        free(opts->path);
...
void
tloc_options_print(TLOC_Options *opts)
{
    printf("opts->path: %s\n", opts->path);
 ...
 * */
bool
tloc_options_map_arg(TLOC_Options *opts, const char *arg_flag, const void *arg_value)
{
