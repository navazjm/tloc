...
MunitResult
tloc_utils_split_cmd_arg_test(const MunitParameter params[], void *data)
{
    (void)data;
...
static char *tloc_utils_string_trim_whitespace_test_str_params[]
...
MunitResult
tloc_utils_string_trim_whitespace_test(const MunitParameter params[], void *data)
{
    (void)data;
...
MunitResult
tloc_utils_string_ends_with_test(const MunitParameter params[], void *data)
{
    (void)data;
...
MunitResult
tloc_utils_string_strip_prefix_test(const MunitParameter params[], void *data)
{
    (void)data;
...
static char *tloc_utils_normalize_file_path_test_path_params[]
    = { "/repos/tloc/src/main.c", "./repos/tloc/src/main.c", "../repos/tloc/src/main.c", "repos/tloc/src/main.c",
        NULL };
...
MunitResult
tloc_utils_normalize_file_path_test(const MunitParameter params[], void *data)
{
    (void)data;
...
static char *tloc_utils_format_file_path_by_pp_option_test_pp_flag_params[]
    = { "NONE", "pp", "pp-s", "pp-a", "pp-as", NULL };
...
MunitResult
tloc_utils_format_file_path_by_pp_option_test(const MunitParameter params[], void *data)
{
    (void)data;
...
MunitTest tloc_utils_tests[]
    = { { (char *)"/split_cmd_arg_test", tloc_utils_split_cmd_arg_test, NULL, NULL, MUNIT_TEST_OPTION_NONE,
          tloc_utils_split_cmd_arg_test_params },
        { (char *)"/string_trim_whitespace_test", tloc_utils_string_trim_whitespace_test, NULL, NULL,
          MUNIT_TEST_OPTION_NONE, tloc_utils_string_trim_whitespace_test_params },
        { (char *)"/string_ends_with_test", tloc_utils_string_ends_with_test, NULL, NULL, MUNIT_TEST_OPTION_NONE,
          tloc_utils_string_ends_with_test_params },
        { (char *)"/string_strip_prefix_test", tloc_utils_string_strip_prefix_test, NULL, NULL, MUNIT_TEST_OPTION_NONE,
          tloc_utils_string_strip_prefix_test_params },
        { (char *)"/normalize_path_test", tloc_utils_normalize_file_path_test, NULL, NULL, MUNIT_TEST_OPTION_NONE,
          tloc_utils_normalize_file_path_test_params },
        { (char *)"/format_path_by_pp_option_test", tloc_utils_format_file_path_by_pp_option_test, NULL, NULL,
          MUNIT_TEST_OPTION_NONE, tloc_utils_format_file_path_by_pp_option_test_params },
